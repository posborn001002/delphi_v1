class DateLookupsController < ApplicationController
  ...
  private
    ...
    def date_lookup_params
      params.require(:date_lookup).permit(:date, :day_of_month, :month, :quarter, :year, :week_of_year, :week_of_quarter, :fiscal_year, :fiscal_month, :fiscal_quarter, :fiscal_week_of_year, :fiscal_week_of_quarter)
    end
end
