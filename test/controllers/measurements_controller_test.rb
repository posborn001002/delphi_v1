...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { DateLookup_id: @measurement.DateLookup_id, Metric_id: @measurement.Metric_id, value: @measurement.value } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { DateLookup_id: @measurement.DateLookup_id, Metric_id: @measurement.Metric_id, value: @measurement.value } }
