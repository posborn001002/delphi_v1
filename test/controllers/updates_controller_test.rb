...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { DateLookup_id: @update.DateLookup_id, Person_id: @update.Person_id, attachment: @update.attachment, text: @update.text } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { DateLookup_id: @update.DateLookup_id, Person_id: @update.Person_id, attachment: @update.attachment, text: @update.text } }
