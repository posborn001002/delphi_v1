...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post metrics_url, params: { metric: { datatype: @metric.datatype, name: @metric.name } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { datatype: @metric.datatype, name: @metric.name } }
